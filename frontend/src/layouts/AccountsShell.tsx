      ...
      <aside className="hidden lg:flex flex-col h-screen w-64 fixed left-0 top-0 bg-zinc-900 z-40 py-6 border-r border-zinc-800/50">
        <div className="px-6 mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-primary font-headline font-black text-xs uppercase tracking-widest">Accounts Portal</h2>
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen">
        <header className="sticky top-0 z-50 bg-zinc-950/80 backdrop-blur-xl flex justify-between items-center w-full px-6 py-3">
          <div className="flex items-center gap-4">
            ...
            <span className="text-[10px] font-label uppercase tracking-widest text-primary border border-primary/30 px-2 py-0.5 rounded">Accounts Dept</span>
          </div>
