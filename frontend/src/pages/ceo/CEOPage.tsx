...
const BRANCH_TARGETS = [
  { display: 'Muvattupuzha',  target: 152, codes: ['MV01A'],          mtdTallyHC: 46 },
  { display: 'Pathanamthitta',target: 130, codes: ['PH01A'],          mtdTallyHC: 21 },
  { display: 'Irinjalakuda',  target: 129, codes: ['IR01A'],          mtdTallyHC: 32 },
  { display: 'Enjakkal',      target: 174, codes: ['TR01C'],          mtdTallyHC: 40 },
  { display: 'Kottayam',      target: 232, codes: ['KT01A', 'KT01B'], mtdTallyHC: 43 },
  { display: 'Kollam',        target: 183, codes: ['KL01A'],          mtdTallyHC: 51 },
  { display: 'Thiruvalla',    target:  92, codes: ['TL01A'],          mtdTallyHC: 26 },
  { display: 'Kalamaserry',   target: 283, codes: ['CO01B'],          mtdTallyHC: 73 },
  { display: 'Kazhakoottam',  target: 171, codes: ['TR01A'],          mtdTallyHC: 52 },
  { display: 'Trichur',       target: 199, codes: ['TI01A'],          mtdTallyHC: 70 },
  { display: 'Kayamkulam',    target: 101, codes: ['KY01A'],          mtdTallyHC: 25 },
  { display: 'Nettoor',       target: 154, codes: ['CO01A'],          mtdTallyHC: 40 },
];
  ...
  return (
    <div className="space-y-8 max-w-[1600px] mx-auto">
      ...
      <section>
        ...
        <div className="grid grid-cols-3 gap-4">
          <KPI label="MTD Tally"         value={Math.max(summary?.mtdTally ?? 0, 519)}                                        color="#F59E0B" icon="receipt_long" />
          <KPI label="Active Blockings"  value={summary?.totalBlockings}                                                        color="#3B82F6" icon="directions_car" />
          <KPI label="Total Visibility"  value={Math.max(summary?.mtdTally ?? 0, 519) + (summary?.totalBlockings ?? 0)}        color="#14B8A6" icon="visibility" />
        </div>
      </section>
